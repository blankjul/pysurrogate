...
from sklearn.utils import deprecated, check_random_state, check_X_y
...
class GaussianProcess(BaseEstimator, RegressorMixin):
    ...
    regr : string or callable, optional
        ...
        Available built-in regression archive are::
    ...
    corr : string or callable, optional
        ...
        Built-in correlation archive are::
    ...
    optimizer : string, optional
        A string specifying the virtual algorithm to be used.
        ...
        instead of running one single multi-dimensional virtual.
    ...
    _regression_types = {
        'constant': regression_models.constant,
        'linear': regression_models.linear,
        'quadratic': regression_models.quadratic}

    _correlation_types = {
        'absolute_exponential': correlation_models.absolute_exponential,
        'squared_exponential': correlation_models.squared_exponential,
        'generalized_exponential': correlation_models.generalized_exponential,
        'cubic': correlation_models.cubic,
        'linear': correlation_models.linear}
    ...
    def __init__(self, regr='constant', corr='squared_exponential', beta0=None,
                 ...
                 nugget=10e-30, random_state=None):
    ...
    def _arg_max_reduced_likelihood_function(self):
        ...
        if self.optimizer == 'EA':
            ...
            class HyperParameterProblem(Problem):
                ...
                def evaluate_(self, x, f):
                    for i in range(x.shape[0]):
                        f[i, 0] = - self.func_likelihood(theta=tuple(x[i, :]))[0]

            problem = HyperParameterProblem(self.theta0.size, self.thetaL[0], self.thetaU,
                                            self.reduced_likelihood_function)
        ...
        elif self.optimizer == 'fmin_cobyla' or self.optimizer == 'f_min':
            ...
            for k in range(self.random_start):
                ...
                try:
                    ...
                    elif self.optimizer == 'f_min':
                        log10_optimal_theta = \
                            scipy.optimize.fmin(minus_reduced_likelihood_function, np.log10(theta0).ravel(), disp=0)
