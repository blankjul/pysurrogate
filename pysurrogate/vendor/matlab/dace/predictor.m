...
if dmodel.regr == 0
    dmodel.regr=@regpoly0;
elseif dmodel.regr == 1
    dmodel.regr=@regpoly1;
elseif dmodel.regr == 2
    dmodel.regr=@regpoly2;
end

if dmodel.corr == 0
    dmodel.corr=@corrcubic;
elseif dmodel.corr == 1
    dmodel.corr=@correxp;
elseif dmodel.corr == 2
    dmodel.corr=@correxpg;
elseif dmodel.corr == 3
    dmodel.corr=@corrgauss;
elseif dmodel.corr == 4
    dmodel.corr=@corrlin;
elseif dmodel.corr == 5
    dmodel.corr=@corrspherical;
elseif dmodel.corr == 6
    dmodel.corr=@corrspline;
end
